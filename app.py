...
# ==========================================
# 2. INISIALISASI SESSION STATE DATA
# ==========================================
...
# ==========================================
# 4. TEMPLATES HTML & CSS (4 MODEL CV)
# ==========================================
...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .profile-img-ats { width: 80px; height: 80px; border-radius: 4px; object-fit: cover; }
    ...
    <table class="header-table">
        <tr>
            ...
            <td width="18%" valign="top">
                <img src="{{ foto_base64 }}" class="profile-img-ats" />
            </td>
            {% endif %}
            <td valign="top">
...
# --- TEMPLATE 3: CREATIVE TWO-COLUMN ---
CREATIVE_HTML = """
<!DOCTYPE html>
<html>
<head>
...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .profile-img-min { width: 70px; height: 70px; border-radius: 50%; object-fit: cover; }
    ...
    <table class="header-table">
        <tr>
            ...
            <td width="15%" valign="bottom">
                <img src="{{ foto_base64 }}" class="profile-img-min" />
            </td>
            {% endif %}
            <td valign="bottom">
                <div class="name">{{ nama }}</div>
